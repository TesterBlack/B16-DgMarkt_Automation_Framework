...
public class Login_Step_Defs {
    ...
    public void the_user_should_be_able_to_see_for_five_invalid_login_attempts(String expectedWarningMessage) {
        String actualWarningMessage = loginPage.warningMessage.getText();
        Assert.assertEquals(expectedWarningMessage, actualWarningMessage);
    }
    ...
    public void the_user_should_be_able_to_see_message(String expectedMessage) {
        String actualMessage = loginPage.emailSentMessage.getText();
