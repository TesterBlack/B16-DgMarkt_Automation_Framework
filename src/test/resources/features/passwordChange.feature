Feature: My Account-User can Change password
  ...
  Scenario Outline: Verifies that the user can change the password. - B16DDM-81
    ...
    Examples:
      | currentPassword | NewPassword | SameNewPassword | SuccessMessage                                        |
      | 123456          | abcd123     | abcd123         | Success: Your password has been successfully updated. |
      | abcd123         | 123456      | 123456          | Success: Your password has been successfully updated. |
